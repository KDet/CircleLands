...
namespace Facebook
{
    sealed class AndroidFacebook : AbstractFacebook, IFacebook
    {
            ...
            HideUnityDelegate hideUnityDelegate = null)
        {
            ...
            var paramJson = Json.Serialize(parameters);
            this.onInitComplete = onInitComplete;

            CallFB("Init", paramJson);
        }
        ...
        {
            var parameters = (Dictionary<string, object>)Json.Deserialize(message);
        ...
        {
            var result = (Dictionary<string, object>)Json.Deserialize(message);
            var callbackId = (string)result[CallbackIdKey];
            result.Remove(CallbackIdKey);
            OnFacebookResponse(callbackId, new FBResult(Json.Serialize(result)));
        }
            ...
            FacebookDelegate callback = null)
        {
            ...
            CallFB("AppRequest", Json.Serialize(paramsDict));
        }

        public void OnAppRequestsComplete(string message)
        {
            var rawResult = (Dictionary<string, object>)Json.Deserialize(message);
            if (rawResult.ContainsKey(CallbackIdKey))
            {
                ...
                else
                {
                    ...
                    OnFacebookResponse(callbackId, new FBResult(Json.Serialize(result), "Malformed request response.  Please file a bug with facebook here: https://developers.facebook.com/bugs/create"));
                }
            }
        }
            ...
            FacebookDelegate callback = null)
        {
            ...
            CallFB("FeedRequest", Json.Serialize(paramsDict));
        }
            ...
            FacebookDelegate callback = null)
        {
            ...
            CallFB("GameGroupCreate", Json.Serialize (paramsDict));
        }
            ...
            FacebookDelegate callback = null)
        {
            ...
            CallFB("GameGroupJoin", Json.Serialize (paramsDict));
        }
            ...
            Dictionary<string, object> parameters = null)
        {
            ...
            CallFB("AppEvents", Json.Serialize(paramsDict));
        }
        ...
        public override void PublishInstall(string appId, FacebookDelegate callback = null)
        {
            ...
            CallFB("PublishInstall", Json.Serialize(parameters));
        }

        public void OnPublishInstallComplete(string message)
        {
            var response = (Dictionary<string, object>)Json.Deserialize(message);
        ...
        public override void ActivateApp(string appId = null)
        {
            ...
            CallFB("ActivateApp", Json.Serialize(parameters));
        }
